		        ...
		        <Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
					<Section className="text-center mb-8">
						...
						<Text className="text-black text-base mt-2">
							Turn on two -factor authentication to increase the safety of your account.
						</Text>
					</Section>
					...
					<Section className="bg-white rounded-lg shadow-md p-6 text-center mb-6">
						...
						<Text className="text-base text-black mt-2">
							Two -factor authentication adds an additional level of protection, requiring a code that is known only to you.
						</Text>
						<Link
							href={settingsLink}
					...
					<Section className="text-center mt-8">
						<Text className="text-gray-600">
							If you have questions, contact the support service at {''}
							<Link
